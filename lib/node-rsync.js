...
var RSync = function (root,size) {
    // DL added root param, tomatch invocation below.
    // console.log('Rsync arguments',arguments);
    this.root=root;
...
RSync.prototype = {
    checksum: function (path, callback) {
        // console.log('performing checksum'.red,path);
        var self = this;
        ...
        fs.readFile(path, function (err, data) {
            ...
            // console.log('checksum'.blue,'done',result);
